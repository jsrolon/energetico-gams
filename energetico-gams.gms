...
Parameters
  c(i,j) matriz de costos de producción de 1MWh en estado i con fuente j
  /   f1    f2    f3
   e1  1     1     1
   e2  1     1     1
   e3  1     1     1
  ...
  p(i)   requerimiento energético del estado i en MWh
  ...
  l(i,j) límite de MWh de energía de tipo j que puede generar  el estado i
  /   f1    f2    f3
   e1
   e2
   e3
  ...
  h(j)   huella de carbón producida por 1MWh de energía de tipo j
